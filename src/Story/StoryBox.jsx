...
const StoryBox = () => {
  return (
    <div className='storybox'>
          ...
          <Story  image={s1} profileSrc={dp1} title="Athar" />
          <Story  image={s2} profileSrc={dp2} title="Shehzad" />
          <Story  image={s3} profileSrc={dp3} title="Ali" />
          <Story  image={s4} profileSrc={dp4} title="Azhar" />
          <Story  image={s5} profileSrc={dp5} title="Usman" />
